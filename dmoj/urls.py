...
urlpatterns = [
    ...
    path('widgets/', include([
        path('rejudge', widgets.rejudge_submission, name='submission_rejudge'), # uuuvcomment
...
#         path('/submit', funix_problem.FunixProblemSubmit.as_view(), name='problem_submit'), # uuuuvcomment changed
#         path('/resubmit/<int:submission>', funix_problem.FunixProblemSubmit.as_view(), name='problem_submit'), # uuuuvcomment changed

#         path('/submit/<str:iframe>', funix_problem.FunixProblemSubmit.as_view(),  name='problem_submit'), # uuuuvcomment changed
#         path('/resubmit/<str:iframe>/iframe', funix_problem.FunixProblemSubmit.as_view(),name='problem_submit'), # uuuuvcomment changed
...
#     path('submission/<int:submission>', include([
#         path('', submission.SubmissionStatus.as_view(), name='submission_status'), 
#         path('/abort', funix_submission.abort_submission, name='submission_abort'), # uuuvcomment
#     ])),
